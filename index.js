...
function handleDeleteClick(tweetId){
    const newTweetsData = tweetsData.filter((tweet) => { return tweet.uuid !== tweetId})
    
    for(let i=0; i<tweetsData.length; i++)
    {
        tweetsData.pop()
    }
    newTweetsData.forEach((el) => {
        tweetsData.push(el)
    })
    render()
}
        ...
        <div class="tweet-reply">
            <div class="tweet-inner">
                ...
                <div>
                    ...
                    <textarea placeholder="Write your reply" class="reply-input" id="reply-input-${tweet.uuid}"></textarea>
                </div>
            </div>
